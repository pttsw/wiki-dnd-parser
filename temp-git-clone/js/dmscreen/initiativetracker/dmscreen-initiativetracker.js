...
export class InitiativeTracker extends BaseComponent {
	...
	_render_getWrpFooter ({wrpTracker, doUpdateExternalStates}) {
		...
		const btnNetworking = ee`<button class="ve-btn ve-btn-primary ve-btn-xs ve-mr-2" title="${I18nUtil.get("page.dmscreen.player_view")} (${I18nUtil.get("page.dmscreen.shift_to_open_standard_view")})"><span class="glyphicon glyphicon-user"></span></button>`
			.onn("click", evt => {
